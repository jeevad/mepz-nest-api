    ...
    for (const element of projects) {
        ...
        for (const element2 of department) {
          ...
          for (const element3 of rooms) {
            ...
            const equipment = await this.get_equipment_by_rooms(element.code,element3.rm_code); 
